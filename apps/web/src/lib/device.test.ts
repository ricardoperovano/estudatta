...
import { detectInstallEnv, detectInstallPlatform, iosSupportsWebPush, iosVersion, isIOS, isStandalone } from "./device";
...
const UA = {
  ...
  iphoneSafari15: "Mozilla/5.0 (iPhone; CPU iPhone OS 15_7 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.7 Mobile/15E148 Safari/604.1",
  ...
  iphoneChrome17: "Mozilla/5.0 (iPhone; CPU iPhone OS 17_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/124.0.6367.88 Mobile/15E148 Safari/604.1",
  iphoneChrome15: "Mozilla/5.0 (iPhone; CPU iPhone OS 15_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/110.0.5481.83 Mobile/15E148 Safari/604.1",
  ...
  iphoneEdge: "Mozilla/5.0 (iPhone; CPU iPhone OS 17_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 EdgiOS/124.0.2478.50 Mobile/15E148 Safari/605.1.15",
  iphoneInstagram: "Mozilla/5.0 (iPhone; CPU iPhone OS 17_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Instagram 330.0.0.0",
  ...
  androidSamsung: "Mozilla/5.0 (Linux; Android 13; SAMSUNG SM-S911B) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/24.0 Chrome/117.0.0.0 Mobile Safari/537.36",
  androidFirefox: "Mozilla/5.0 (Android 14; Mobile; rv:125.0) Gecko/125.0 Firefox/125.0",
  androidEdge: "Mozilla/5.0 (Linux; Android 14; Pixel 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36 EdgA/124.0.2478.64",
  androidWebView: "Mozilla/5.0 (Linux; Android 14; Pixel 7; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/124.0.0.0 Mobile Safari/537.36",
  winChrome: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",
  winEdge: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36 Edg/124.0.2478.67",
...
describe("detectInstallPlatform", () => {
  ...
  it("agrupa e informa navegador e push", () => {
    expect(detectInstallEnv(UA.iphoneChrome17, phone)).toMatchObject({ group: "ios", mobile: true, browser: "Chrome", pushCapable: true });
    expect(detectInstallEnv(UA.iphoneSafari15, phone)).toMatchObject({ group: "ios", pushCapable: false });
    expect(detectInstallEnv(UA.androidSamsung, {})).toMatchObject({ group: "android", mobile: true, browser: "Samsung Internet", iosVersion: null });
    expect(detectInstallEnv(UA.winEdge, {})).toMatchObject({ group: "desktop", mobile: false, browser: "Edge" });
  });
});

describe("isStandalone", () => {
  const win = (standaloneMq: boolean, navStandalone?: boolean) =>
    ({ matchMedia: (q: string) => ({ matches: standaloneMq && q.includes("standalone") }), navigator: { standalone: navStandalone } }) as unknown as Window;
