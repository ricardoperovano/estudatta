...
export const STARTERS: Starter[] = [
  {
    key: "idioma",
    title: t("Idioma"),
    meta: t("30 min · seg a sex"),
    hint: t("Inglês, espanhol, Libras…"),
    icon: Translate,
    tint: "bg-accent-900 text-accent",
    params: { nome: t("Inglês"), categoria: "idioma", idioma: "en", minutos: 30, dias: WEEKDAYS },
  },
  {
    key: "concurso",
    title: t("Concurso"),
    meta: t("2h · seg a sáb"),
    hint: t("Edital, matérias e simulados"),
    icon: Exam,
  ...
  },
  {
    ...
    title: t("Faculdade"),
    meta: t("1h · seg a sex"),
    hint: t("Disciplinas, provas e trabalhos"),
    icon: GraduationCap,
  ...
  },
  {
    key: "leitura",
    title: t("Leitura"),
    meta: t("20 min · todo dia"),
    hint: t("Um livro por vez, sem pressa"),
    icon: BookOpenText,
  ...
  },
  {
    ...
    title: t("Instrumento"),
    meta: t("30 min · 3×/sem"),
    hint: t("Violão, piano, desenho…"),
    icon: MusicNotes,
    tint: "bg-accent-900 text-accent",
    params: { nome: t("Violão"), categoria: "pratica", minutos: 30, dias: [0, 2, 4] },
  },
  {
    key: "rotina",
    title: t("Rotina"),
    meta: t("checklist · sem tempo"),
    hint: t("Tarefas para marcar como feitas"),
    icon: ListChecks,
    tint: "bg-info-tint text-info",
    params: { nome: t("Rotina de estudos"), categoria: "rotina", modo: "checklist" },
  },
];
