...
export type TataMood = "idle" | "focus" | "cheer" | "sleep" | "paused" | "wave" | "encourage" | "love" | "think";
  ...
  return (
    ...
    >
      ...
      <g className="tata-body">
        ...
        <path className="tata-tail" d="M136 168 L136 200 L146 192 L156 200 L156 164 Z" fill="#d9a86a" stroke="#b9854a" strokeWidth="2" strokeLinejoin="round" />
        {/* pés */}
        <ellipse cx="78" cy="186" rx="15" ry="9" fill="#5b4fa8" />
        <ellipse cx="122" cy="186" rx="15" ry="9" fill="#5b4fa8" />
        {/* braços */}
        <path className="tata-arm tata-arm--left" d="M36 116 C22 122 16 134 18 146" fill="none" stroke="#5b4fa8" strokeWidth="9" strokeLinecap="round" />
        <path className="tata-arm tata-arm--right" d="M164 116 C178 122 184 134 182 146" fill="none" stroke="#5b4fa8" strokeWidth="9" strokeLinecap="round" />
        {/* pino e botão do cronômetro */}
        <rect x="93" y="30" width="14" height="14" rx="3" fill="#6f63b8" />
        <rect className="tata-knob" x="82" y="16" width="36" height="18" rx="9" fill="#5b4fa8" stroke="#8e7cd6" strokeWidth="2" />
        ...
        {mood === "cheer" || mood === "love" ? (
          <path d="M88 128 Q100 146 112 128 Z" fill="#292b31" stroke="#292b31" strokeWidth="2" strokeLinejoin="round" />
        ) : mood === "sleep" ? (
          <ellipse cx="100" cy="134" rx="4" ry="5" fill="#292b31" />
        ) : mood === "think" ? (
          <path d="M92 134 Q100 130 108 134" fill="none" stroke="#292b31" strokeWidth="3.5" strokeLinecap="round" />
        ) : (
          <path d="M90 128 Q100 138 110 128" fill="none" stroke="#292b31" strokeWidth="3.5" strokeLinecap="round" />
        )}
        {/* livrinho (foco) */}
        <g className="tata-book">
          <path d="M60 150 L100 158 L140 150 L140 176 L100 184 L60 176 Z" fill="#f3f5fe" stroke="#2d2f3a" strokeWidth="3" strokeLinejoin="round" />
        ...
        <g className="tata-cup">
          <path d="M146 160 L170 160 L167 182 L149 182 Z" fill="#d9a86a" stroke="#2d2f3a" strokeWidth="2.5" strokeLinejoin="round" />
          <path d="M170 164 Q180 168 169 176" fill="none" stroke="#2d2f3a" strokeWidth="2.5" />
          <path className="tata-steam" d="M154 154 q-4 -6 0 -12 M162 154 q-4 -6 0 -12" fill="none" stroke="#b2b6ca" strokeWidth="2" strokeLinecap="round" />
        </g>
      </g>
      {/* efeitos */}
      <g className="tata-zzz" fill="#9184d9" fontFamily="Inter, system-ui, sans-serif" fontWeight="600">
        <text x="150" y="60" fontSize="18">z</text>
        <text x="164" y="44" fontSize="14">z</text>
        <text x="176" y="30" fontSize="11">z</text>
      </g>
