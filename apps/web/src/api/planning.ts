...
export const planningKeys = {
  calendar: (start: string, end: string, activityId?: string | null) => ["calendar", start, end, activityId ?? null] as const,
  tasks: (start: string, end: string, activityId?: string | null) => ["tasks", start, end, activityId ?? null] as const,
...
export function useCalendar(start: string, end: string, activityId?: string | null) {
  return useQuery({
    ...
    queryFn: async () => unwrap(await api.GET("/api/v1/calendar", { params: { query: { start, end, activity_id: activityId ?? null } } })) as CalendarOut,
    staleTime: 15_000,
  });
}
...
export function useTasks(start: string, end: string, activityId?: string | null, enabled = true) {
  return useQuery({
    ...
    enabled,
    queryFn: async () => unwrap(await api.GET("/api/v1/tasks", { params: { query: { start, end, activity_id: activityId ?? null } } })) as Task[],
    staleTime: 15_000,
  });
}
...
export function useSeries(activityId?: string | null, enabled = true) {
  return useQuery({
    ...
    enabled,
    queryFn: async () => unwrap(await api.GET("/api/v1/tasks/series", { params: { query: { activity_id: activityId ?? null } } })) as Series[],
  });
}
...
export function useDeleteTask() {
  const invalidate = useInvalidatePlanning();
  return useMutation({
    mutationFn: async (id: string) => unwrap(await api.DELETE("/api/v1/tasks/{task_id}", { params: { path: { task_id: id } } })),
    onSuccess: invalidate,
  });
}
...
export function useRescheduleTask() {
  ...
  return useMutation({
    mutationFn: async ({ id, body }: { id: string; body: RescheduleIn }) =>
      unwrap(await api.POST("/api/v1/tasks/{task_id}/reschedule", { params: { path: { task_id: id } }, body })) as Task,
    onSuccess: invalidate,
  });
}
...
export function useSkipTask() {
  const invalidate = useInvalidatePlanning();
  return useMutation({
    mutationFn: async (id: string) => unwrap(await api.POST("/api/v1/tasks/{task_id}/skip", { params: { path: { task_id: id } } })) as Task,
    onSuccess: invalidate,
  });
}
...
export function useCompleteTask() {
  ...
  return useMutation({
    mutationFn: async ({ id, done }: { id: string; done: boolean }) =>
        ...
        ? (unwrap(await api.POST("/api/v1/tasks/{task_id}/complete", { params: { path: { task_id: id } } })) as Task)
        : (unwrap(await api.POST("/api/v1/tasks/{task_id}/uncomplete", { params: { path: { task_id: id } } })) as Task),
    onSuccess: invalidate,
  });
}
...
export function useMaterializeOccurrence() {
  ...
  return useMutation({
    mutationFn: async ({ seriesId, date, body }: { seriesId: string; date: string; body: OccurrenceIn }) =>
      unwrap(await api.POST("/api/v1/tasks/series/{series_id}/occurrences/{local_date}", { params: { path: { series_id: seriesId, local_date: date } }, body })) as Task,
    onSuccess: invalidate,
  });
}
...
export function useCreateSeries() {
  const invalidate = useInvalidatePlanning();
  return useMutation({
    mutationFn: async (body: SeriesCreate) => unwrap(await api.POST("/api/v1/tasks/series", { body })) as Series,
    onSuccess: invalidate,
  });
}
...
export function useUpdateSeries() {
  ...
  return useMutation({
    mutationFn: async ({ id, body }: { id: string; body: SeriesUpdate }) =>
      unwrap(await api.PATCH("/api/v1/tasks/series/{series_id}", { params: { path: { series_id: id } }, body })) as Series,
    onSuccess: invalidate,
  });
}
...
export function useDeleteSeries() {
  const invalidate = useInvalidatePlanning();
  return useMutation({
    mutationFn: async (id: string) => unwrap(await api.DELETE("/api/v1/tasks/series/{series_id}", { params: { path: { series_id: id } } })),
    onSuccess: invalidate,
  });
}
...
export function useAutoPlanPreview(activityId: string) {
  return useMutation({
    mutationFn: async (body: AutoPlanIn) =>
      unwrap(await api.POST("/api/v1/activities/{activity_id}/auto-plan/preview", { params: { path: { activity_id: activityId } }, body })) as AutoPlanOut,
  });
}
...
export function useAutoPlanApply(activityId: string) {
  ...
  return useMutation({
    mutationFn: async (body: AutoPlanIn) =>
      unwrap(await api.POST("/api/v1/activities/{activity_id}/auto-plan", { params: { path: { activity_id: activityId } }, body })) as AutoPlanOut,
    onSuccess: invalidate,
  });
}
...
export function useWeekPrint(start: string, activityId?: string | null) {
  return useQuery({
    ...
    queryFn: async () => unwrap(await api.GET("/api/v1/planning/week-print", { params: { query: { start, activity_id: activityId ?? null } } })) as WeekPrintOut,
  });
}
